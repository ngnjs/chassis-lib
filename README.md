This library (NGN 1.x.x) has been replaced by [NGN 2](https://github.com/ngnjs/ngn). This repository is no longer maintained and remains only to assist with any migration eforts.
